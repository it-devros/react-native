        ...
        <ScrollView style={{ backgroundColor: 'rgba(255, 94, 58, 0.75)' }}>
          <View style={styles.container}>
            ...
            <View style={styles.headerSection}>
              ...
              <Button onPress={this.goToRegister} buttonStyle={styles.signUpButton} title={'Register Now!'}/>
            </View>
            <View style={styles.bodySection}>
              <View style={styles.pannel}>
                <View style={styles.headerPannel}>
                  <Text style={styles.pannelHeaderText}>Login To your Account</Text>
                </View>
                <View style={styles.bodyPannel}>
                  <View style={styles.InputElement}>
                    <Text style={styles.caption}>Email or Username</Text>
                    <TextInput style={styles.inputField} value={''} placeholder={"Enter Email"}/>
                  </View>
                  <View style={styles.InputElement}>
                    <Text style={styles.caption}>Password</Text>
                    <TextInput style={styles.inputField} value={''} placeholder={"Enter Password"}/>
                  </View>
                  <Text style={styles.fogotCaption}>Forgotten Password?</Text>
                  <Button onPress={this.doLogIn} buttonStyle={styles.loginButton} title={'Login'}/>
                  <View style={{flexDirection: 'row', flexWrap: 'wrap', marginBottom: 15}}>
                    <Text style={styles.footerCaption}>Don’t you have an account? </Text>
                    <TouchableOpacity onPress={this.goToRegister}><Text style={{color: 'red'}} >Register</Text></TouchableOpacity>
                    <Text style={styles.footerCaption}>it’s really simple and you can start enjoing all the benefits!</Text>
                  </View>
